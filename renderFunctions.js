...
function renderTopBarStats(stateObj) {
    ...
    const oldChild = document.getElementById("fast-changing-button")
    const newChild = document.createElement("button")
    newChild.id = "fast-changing-button"
    const newChild_content = document.createTextNode("69")
    newChild.appendChild(newChild_content)
    newChild.addEventListener("click", () => {
      console.log("clicked!")
      newChild.textContent = "Clicked"
    })

    document.getElementById("main").replaceChild(newChild, oldChild)
